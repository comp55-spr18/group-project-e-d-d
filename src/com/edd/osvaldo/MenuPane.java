...
public class MenuPane extends GraphicsPane {
	...
	private GImage background = new GImage("com/edd/osvaldo/Brick-wallaper-For-Background-19.jpg");
	...
	public MenuPane(MainApplication app) {
		...
		rect = new GButton("Single Player", (program.WINDOW_WIDTH - 200) / 2, (program.WINDOW_HEIGHT - 200) / 2, 200, 100);
